...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/index.php/Admin/Goods/edit/id/21/p/1.html" method="post">
            ...
            <table style="display:none;" width="90%" class="table_form" align="center">
            	...
            	<?php  $attr_id = array(); foreach ($attrData as $k => $v): if(!in_array($v['id'], $attr_id)) { $opt = '+'; $attr_id[] = $v['id']; } else $opt = '-'; ?>
            		<li>
	            		...
	            		<?php else: ?>
	            			<select name="old_attr_value[<?php echo $v['goods_attr_id']; ?>]">
	            				...
	            				<?php  $_attr = explode(',', $v['attr_option_values']); foreach ($_attr as $k1 => $v1): if($v1 == $v['attr_value']) $select = 'selected="selected"'; else $select = ''; ?>
