...
<!--引入导航条-->
<?php
$catModel = D('Admin/Category'); $_data = $catModel->getNavData(); ?>
<!-- 头部 start -->
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			<!--  商品分类部分 start-->
			<div class="category fl <?php if($_page_hide_nav==1) echo 'cat1'; ?>"> <!-- 非首页，需要添加cat1类 -->
				<div class="cat_hd <?php if($_page_hide_nav==1) echo 'off'; ?>">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
					<h2>全部商品分类</h2>
					<em></em>
				</div>
				
				<div class="cat_bd <?php if($_page_hide_nav==1) echo 'none'; ?>">
					<!-- 循环顶级 -->
					<?php foreach ($_data as $k => $v): if($k > 12) break ; ?>
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						...
						<li>
							<dl>
								<dt><a href="<?php echo U('Index/goods?id='.$v['id']); ?>"><img src="/Public/Uploads/<?php echo $v['sm_logo']; ?>" alt="" /></a></dt>
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					<ul>
						<!-- 循环未推荐的二级分类 -->
						<?php foreach ($v['normalSubCat'] as $k1 => $v1): ?>
			...
			<div class="goodslist fl">
				...
				<div class="goodslist_wrap">
					...
					<div <?php if($k1>0) echo 'class="none"'; ?>>
						<ul>
							<!-- 循环分类下的商品 -->
							<?php foreach ($v1['recGoods'] as $k2 => $v2): ?>
							<li>
								<dl>
									<dt><a href="<?php echo U('Index/goods?id='.$v2['id']); ?>"><img src="/Public/Uploads/<?php echo $v2['sm_logo']; ?>" alt="" /></a></dt>
									<dd><a href="<?php echo U('Index/goods?id='.$v2['id']); ?>"><?php echo $v2['goods_name']; ?></a></dd>
